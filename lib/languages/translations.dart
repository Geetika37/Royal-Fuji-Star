...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ar_AE': {
          ...
          'policy_terms2': 'شروط الخدمة ',
          'policy_terms3': 'أيضا ',
          'policy_terms4': 'سياسة الخصوصية',
          ...
          'sparecontainertext2': 'قطعة منفصلة',
          'sparecontainertext3':
          ...
          'noenquiry': 'لم يتم العثور على استفسار',
          'history1': 'الصيانة السنوية',
          'history2': 'بصلح',
          'history3': 'استشارية',
          'history4': 'الإستفسار عن المنتج',
          'history5': 'استعلام عن قطع الغيار',
          'history6': 'لم يتم العثور على قطع الغيار',
          'histor7': 'اسم العلامة التجارية :',
          'histor8': 'يكتب :',
          'histor9': 'سعة :',
          'histor10': 'عدد الطوابق :',
          'histor11': 'وصف :',
          'histor12': 'نوع الاستشارة :',
          'histor13': 'تعليقات أو أسئلة:',
          'histor14': 'اسم المنتج :',
          'histor15': 'لا مكونات',
          'histor16': 'اسم المكون :',
          'histor17': 'نوع الإصلاحات :',
          'histor18': 'الصور',
          'histor19': 'اسم الغيار :',
          'histor20': 'لا قطع الغيار',
          'histor21': 'نجاح',
          'histor22': 'مُقَدَّم',
          'histor23': 'تم إرسال كلمة المرور لمرة واحدة (OTP) بنجاح',
          'histor24': 'خطأ',
          'histor25': 'تم تغيير كلمة المرور بنجاح',
          'validation1': 'لا يمكن أن تكون كلمة المرور فارغة',
          'validation2': 'يجب أن تتكون كلمة المرور من 8 أحرف على الأقل',
          'validation3': 'يجب أن تحتوي كلمة المرور على حرف كبير واحد على الأقل',
          'validation4': 'يجب أن تحتوي كلمة المرور على حرف صغير واحد على الأقل',
          'validation5': 'يجب أن تحتوي كلمة المرور على رقم واحد على الأقل',
          'validation6': 'يجب أن تحتوي كلمة المرور على حرف خاص واحد على الأقل',
          'validation7': 'أدخل الاسم الصحيح',
          'validation8': 'لا يمكن أن يكون الحقل فارغاً',
          'validation9': 'أدخل الموقع الصحيح',
          'validation10': 'أدخل اسم العلامة التجارية الصحيح',
          'validation11': 'أدخل البريد الإلكتروني الصحيح',
          'validation12': 'انتهت الجلسة',
          'validation13':
              'انتهت صلاحية جلسة العمل الخاصة بك. الرجاد الدخول على الحساب من جديد.',
          'validation14': 'خطئ في التحقق',
          'validation15': 'كلمة المرور ليست هي نفسها',
          'validation16': 'الرجاء تحديد خيار صالح',
          'validation18': 'إصلاح مرة واحدة',
          'validation19': 'إصلاح كبير',
          'validation20': 'استبدال وحدات التحكم وغيرها',
          'validation21': 'الرجاء تحديد صورة واحدة على الأقل',
          'validation22': 'خطة لبناء فيلا جديدة',
          'validation23': 'هل تبحث عن مصعد مناسب لمنزلك',
          'validation24':
              'البحث عن تفاصيل المصعد وفقًا لمواصفات المنطقة المتوفرة لديك',
          'validation25': 'بحاجة إلى إجراء فحص للرفع المثبت',
          'validation26': "KGأكثر من 1000 ",
